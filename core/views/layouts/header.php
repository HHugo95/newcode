            ...
            <div class="items-xl cabecalho__right-side flex">
                ...
                <div class="dropdown">
                    ...
                    <div id="myDropdown" class="caixa user__menu "> 
                        <ul>
                            <li class="caixa-item"><a href="a?perfil" >Editar Perfil</a></li>
        ...
        <div class="cabecalho__content">
            ...
            <div class="cabecalho__right-side">
                <nav>
                    <ul class="flex">
                        <li> 
                            <a href="?a=login"class="botao--container"> Entrar </a>
                        </li>
                        <li > 
                            <a href="?a=cadastro"  class="botao--container border " > Criar conta </a>
                        </li>
                    </ul>
                </nav>
            </div>
